...
Started with (N, dt) = (10, 0.1) (as preferred in videos). 
Increasing N to 15,20,25 and dt to 0.15,0.20 improved the fit in start and made the vehicle drive smoother, but computationally less effiecient for my old configuration PC.
So I settled for the values mentioned in videos, but ofcourse can change as required depending the computationally efficient machines.
